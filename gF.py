...
def loadImage():
    gunAlpha=150
    green=pygame.image.load('resource/playerFire/mainFire_green.png')
    green=pygame.transform.scale(green,(48,48))
    green.set_alpha(gunAlpha)
    global_var.set_value('playerFire_green',green)
    blue=pygame.image.load('resource/playerFire/mainFire_blue.png')
    blue=pygame.transform.scale(blue,(48,48))
    blue.set_alpha(gunAlpha)
    global_var.set_value('playerFire_blue',blue)
    red=pygame.image.load('resource/playerFire/mainFire_red.png')
    red=pygame.transform.scale(red,(48,48))
    red.set_alpha(gunAlpha)
    global_var.set_value('playerFire_red',red)
    yellow=pygame.image.load('resource/playerFire/mainFire_yellow.png')
    yellow=pygame.transform.scale(yellow,(48,48))
    yellow.set_alpha(gunAlpha)
    global_var.set_value('playerFire_yellow',yellow)
    orange=pygame.image.load('resource/playerFire/mainFire_orange.png')
    orange=pygame.transform.scale(orange,(48,48))
    orange.set_alpha(gunAlpha)
    global_var.set_value('playerFire_orange',orange)

    global_var.set_value('levelText01',pygame.image.load('resource/text/levelText01.png'))
    global_var.set_value('pl00',pygame.image.load('resource/player/pl00/playerImage.png'))
    global_var.set_value('mainText',pygame.image.load('resource/text/mainText01.png'))
    global_var.set_value('cloud_bg',pygame.image.load('resource/background/cloud.png'))
    global_var.set_value('lake_bg',pygame.image.load('resource/background/lake.png'))
    global_var.set_value('star_bg',pygame.image.load('resource/background/star.png'))

    spirit=pygame.image.load('resource/enemy/spirit.png')
    spirit=pygame.transform.scale(spirit,(576,384))
    global_var.set_value('spirit',spirit)
    ghost=pygame.image.load('resource/enemy/ghost.png')
    ghost=pygame.transform.scale(ghost,(384,192))
    global_var.set_value('ghost',ghost)
    nimbus=pygame.image.load('resource/enemy/nimbus1.png')
    nimbus=pygame.transform.scale(nimbus,(192,48))
    global_var.set_value('nimbus',nimbus)
    item=pygame.image.load('resource/item/item.png')
    item=pygame.transform.scale(item,(384,24))
    global_var.set_value('itemImage',item)

    boss_1=pygame.image.load('resource/boss/satori.png')
    boss_1=pygame.transform.scale(boss_1,(288,297))
    global_var.set_value('boss_1',boss_1)
    bossTracker=pygame.image.load('resource/text/bossTracker.png')
    ...
    hogwarts_background=pygame.image.load('resource/background/hogwarts.png')
    global_var.set_value('hogwarts_background',hogwarts_background)
    stars_background=pygame.image.load('resource/background/stars.jpg').convert()
