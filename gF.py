...
def loadImage():
    ...
    butterfly_bullet_image=pygame.transform.scale(butterfly_bullet_image,(384,48))
    ...
    satsu_bullet_image=pygame.transform.scale(satsu_bullet_image,(384,24))
    ...
    satoriImg=pygame.transform.scale(satoriImg,(384,768)).convert_alpha()
