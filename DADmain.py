...
icon_img=assets.load_image("star_salvation_enUS.ico", convert_alpha=False)
pygame.display.set_caption("Touhou Star Salvation")
pygame.display.set_icon(icon_img)
back=assets.load_image('resource/background.jpg')
point=assets.load_image('resource/point.png', scale=(96,96), smooth=True)
point2=assets.load_image('resource/point2.png', scale=(96,96), smooth=True)
point2.set_alpha(128)
engFontPath='./resource/font/open-sans/OpenSans-Regular.ttf'
myfont=assets.load_font(engFontPath, 12)
bigfont= assets.load_font(engFontPath, 24)
midfont=assets.load_font(engFontPath, 20)
chfont=assets.load_font('./resource/font/FeiHuaSongTi-2.ttf', 20)
smallfont=assets.load_sysfont('arial', 16)
levelText1 = myfont.render('Level 1', True, (0, 0, 0))
bossMagic=assets.load_image('resource/bossMagic.png')

#load background Pic
back_up=assets.load_image('resource/up.jpg')
global_var.set_value('up', back_up)
back_down=assets.load_image('resource/down.jpg')
global_var.set_value('down', back_down)
back_left=assets.load_image('resource/left.jpg')
global_var.set_value('left', back_left)
back_right=assets.load_image('resource/right.jpg')
...
miss_sound=assets.load_sound('resource/sound/se_pldead00.wav')
miss_sound.set_volume(0.2)
shoot_sound=assets.load_sound('resource/sound/se_plst00.wav')
shoot_sound.set_volume(0.15)
hit_sound1=assets.load_sound('resource/sound/se_damage00.wav')
hit_sound1.set_volume(0.2)
global_var.set_value('hit_sound1',hit_sound1)
hit_sound2=assets.load_sound('resource/sound/se_damage01.wav')
hit_sound2.set_volume(0.2)
global_var.set_value('hit_sound2',hit_sound2)
enemyDead_sound=assets.load_sound('resource/sound/se_enep00.wav')
enemyDead_sound.set_volume(0.15)
global_var.set_value('enemyDead_sound',enemyDead_sound)
bossDead_sound=assets.load_sound('resource/sound/se_enep01.wav')
bossDead_sound.set_volume(0.30)
global_var.set_value('bossDead_sound',bossDead_sound)
enemyGun_sound1=assets.load_sound('resource/sound/se_tan00.wav')
enemyGun_sound1.set_volume(0.1*enemy_sound_amplify)
global_var.set_value('enemyGun_sound1',enemyGun_sound1)
enemyGun_sound2=assets.load_sound('resource/sound/se_tan01.wav')
enemyGun_sound2.set_volume(0.1*enemy_sound_amplify)
global_var.set_value('enemyGun_sound2',enemyGun_sound2)
enemyGun_sound3=assets.load_sound('resource/sound/se_tan02.wav')
enemyGun_sound3.set_volume(0.1*enemy_sound_amplify)
global_var.set_value('enemyGun_sound3',enemyGun_sound3)
slash_sound=assets.load_sound('resource/sound/se_slash.wav')
slash_sound.set_volume(0.5)
item_get=assets.load_sound('resource/sound/se_item00.wav')
item_get.set_volume(0.12)
global_var.set_value('item_get',item_get)
life_get=assets.load_sound('resource/sound/se_extend.wav')
life_get.set_volume(0.35)
global_var.set_value('life_get',life_get)
water_sound=assets.load_sound('resource/sound/se_water.wav')
water_sound.set_volume(0.2*enemy_sound_amplify)
global_var.set_value('water_sound',water_sound)
kira_sound=assets.load_sound('resource/sound/se_kira00.wav')
kira_sound.set_volume(0.1*enemy_sound_amplify)
global_var.set_value('kira_sound',kira_sound)
kira1_sound=assets.load_sound('resource/sound/se_kira01.wav')
kira1_sound.set_volume(0.1*enemy_sound_amplify)
global_var.set_value('kira1_sound',kira1_sound)
powerup_sound=assets.load_sound('resource/sound/se_powerup.wav')
powerup_sound.set_volume(0.3*enemy_sound_amplify)
global_var.set_value('powerup_sound',powerup_sound)
ch00_sound=assets.load_sound('resource/sound/se_ch00.wav')
ch00_sound.set_volume(0.3)
global_var.set_value('ch00_sound',ch00_sound)
timeout_sound=assets.load_sound('resource/sound/se_timeout.wav')
timeout_sound.set_volume(0.25)
global_var.set_value('timeout_sound',timeout_sound)
bonus_sound=assets.load_sound('resource/sound/se_bonus.wav')
bonus_sound.set_volume(0.25)
global_var.set_value('bonus_sound',bonus_sound)
spell_sound=assets.load_sound('resource/sound/se_cat00.wav')
spell_sound.set_volume(0.50)
global_var.set_value('spell_sound',spell_sound)
laser_sound=assets.load_sound('resource/sound/se_lazer00.wav')
laser_sound.set_volume(0.18)
global_var.set_value('laser_sound',laser_sound)
option_sound=assets.load_sound('resource/sound/se_option.wav')
option_sound.set_volume(0.2)
global_var.set_value('option_sound',option_sound)
graze_sound=assets.load_sound('resource/sound/se_graze.wav')
graze_sound.set_volume(0.3)
global_var.set_value('graze_sound',graze_sound)
nep_sound=assets.load_sound('resource/sound/se_nep00.wav')
nep_sound.set_volume(0.3)
global_var.set_value('nep_sound',nep_sound)
spell_end=assets.load_sound('resource/sound/se_enep02.wav')
spell_end.set_volume(0.35)
global_var.set_value('spell_end',spell_end)
enemyBigGun_sound=assets.load_sound('resource/sound/se_enep02.wav')
enemyBigGun_sound.set_volume(0.15)
global_var.set_value('enemyBigGun_sound',enemyBigGun_sound)
pause_sound=assets.load_sound('resource/sound/se_pause.wav')
pause_sound.set_volume(0.35)
global_var.set_value('pause_sound',pause_sound)
select_sound=assets.load_sound('resource/sound/se_select00.wav')
select_sound.set_volume(0.35)
global_var.set_value('select_sound',select_sound)
ok_sound=assets.load_sound('resource/sound/se_ok00.wav')
ok_sound.set_volume(0.35)
global_var.set_value('ok_sound',ok_sound)
cancel_sound=assets.load_sound('resource/sound/se_cancel00.wav')
cancel_sound.set_volume(0.35)
global_var.set_value('cancel_sound',cancel_sound)
invalid_sound=assets.load_sound('resource/sound/se_invalid.wav')
invalid_sound.set_volume(0.35)
global_var.set_value('invalid_sound',invalid_sound)
reimuBoom_sound=assets.load_sound('resource/sound/se_tan00.wav')
